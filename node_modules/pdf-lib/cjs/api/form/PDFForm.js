    ...
    PDFForm.prototype.flatten = function (options) {
        ...
        for (var i = 0, lenFields = fields.length; i < lenFields; i++) {
            ...
            var _loop_1 = function (j, lenWidgets) {
                ...
                var rotation = rotations_1.degrees((_b = ap === null || ap === void 0 ? void 0 : ap.getRotation()) !== null && _b !== void 0 ? _b : 0);
                var operators = [
                    operators_1.pushGraphicsState(),
                    operators_1.translate(rectangle.x, rectangle.y),
                    operators_1.rotateRadians(rotations_1.toRadians(rotation)),
